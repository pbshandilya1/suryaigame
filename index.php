...
<body>
    <div class="affi-desktop">
        ...
        <nav>
            <div class="btn-wp-mob">
                ...
                <a class="wp-btn wp-btn-a" href="https://wa.me/918766212530"
        ...
        <div class="container">
            <div class="content">
                ...
                <a class="wp-btn" href="https://wa.me/918766212530"
                    style="display: inline-flex; align-items: center; justify-content: center; gap: 6px; padding: 12px 24px; background: #25D366; color: white; text-decoration: none; border-radius: 6px; font-weight: 500; white-space: nowrap; min-width: 140px;">
                    WhatsApp us
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="white" style="flex-shrink: 0;"
                        xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- ✅ WhatsApp Button -->
        <a href="https://wa.me/918766212530" target="_blank" class="whatsapp-float"
    ...
    <div class="affi-mob">
        <a href="https://wa.me/918766212530">
            <img src="https://res.cloudinary.com/dr82lzv6s/image/upload/v1769600796/affi1_lnwvxd.jpg"
            alt="">
            <img class="wp-img" src="https://res.cloudinary.com/dr82lzv6s/image/upload/v1769600742/Wp_animated_equoz2.gif"
            alt="">
        </a>
    </div>
